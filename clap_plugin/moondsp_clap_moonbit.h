 ...
 * Source: _build/native/release/build/clap_plugin/clap_plugin.c
 * Output: clap_plugin/moondsp_clap_moonbit.h
 *
...
int32_t _M0FP39dowdiness7moondsp10clap__host23engine__all__notes__off(int32_t handle);
...
double _M0FP39dowdiness7moondsp10clap__host20engine__master__gain(int32_t handle);
double _M0FP39dowdiness7moondsp10clap__host19engine__voice__gain(int32_t handle);
double _M0FP39dowdiness7moondsp10clap__host18engine__cutoff__hz(int32_t handle);
double _M0FP39dowdiness7moondsp10clap__host17engine__resonance(int32_t handle);
