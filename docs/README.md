...
[Svelte synth guide](../examples/svelte-synth/README.md) or its
[framework-free counterpart](../examples/vanilla-synth/README.md), then use the
browser contract's [graph lifecycle](browser-api-contract.md#rendering-and-lifecycle)
