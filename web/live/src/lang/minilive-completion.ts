...
const METHODS: Completion[] = [
  ...
  snippetCompletion("gain(${amount})", { label: "gain", type: "method", detail: "synth voice level" }),
  snippetCompletion("lpf(${hz}, ${resonance})", { label: "lpf", type: "method", detail: "low-pass cutoff and optional resonance (Q)" }),
  snippetCompletion("hpf(${hz}, ${resonance})", { label: "hpf", type: "method", detail: "high-pass cutoff and optional resonance (Q)" }),
  ...
  snippetCompletion("degradeBy(${p}, ${seed})", { label: "degradeBy seed", type: "method", detail: "repeatable event dropout" }),
  snippetCompletion("lowest()", { label: "lowest", type: "method", detail: "lowest simultaneous chord tone" }),
  snippetCompletion("voicing(${48}, ${79})", { label: "voicing", type: "method", detail: "octave-fold all fitting tones; optional count" }),
  snippetCompletion('mask("${x ~ x x}")', { label: "mask", type: "method", detail: "filter existing onsets across an entry period" }),
  snippetCompletion("transpose(${semitones})", { label: "transpose", type: "method", detail: "chromatic pitch shift" }),
  snippetCompletion('steps("${C D E F G A B}", ${steps})', { label: "steps", type: "method", detail: "pitch-class scale shift" }),
  snippetCompletion("phase(transpose(${2}), ${0.5})", { label: "phase", type: "method", detail: "transpose onsets in [from, to); to defaults to 1" }),
  snippetCompletion('tail(note("${E4}"))', { label: "tail", type: "method", detail: "replace final cycle; optional duration" }),
